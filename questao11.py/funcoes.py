from funcoes import calcula_pontos_quina, calcula_pontos_full_house, calcula_pontos_quadra, calcula_pontos_soma, calcula_pontos_sequencia_alta, calcula_pontos_sequencia_baixa
